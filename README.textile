...
<pre><code>imagery_coverable_table_name = 'naip_ca_2010_nad83utm11n' #imagery coverage postgis table name</code></pre>
...
<pre><code>matching_tiles = zoom_stitcher.find_matching_tiles(bounding_boxes[0],master_srid,imagery_coverable_table_name,postgis_connection)</code></pre>
...
<pre><code>zoom_stitcher.zoom_stitcher(bounding_boxes,master_srid,imagery_coverable_table_name,render_destination,local_imagery_root,postgis_connection,db_name,max_stitched_width,max_stitched_height)</code></pre>